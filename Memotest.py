...
from jugador import procesar_resultados, obtener_jugadores, NOMBRE
...
def memotest_juego(tablero, jugadores):
    ...
    while not finalizar(tablero):
        ...
        if not procesar_resultados(tablero, jugadores, jugador_actual_id, (primera_posicion, segunda_posicion)):
